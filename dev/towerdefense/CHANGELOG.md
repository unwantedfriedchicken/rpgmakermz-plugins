...
- ADD: Debug option in parameter when debug mode `hold 1` to multiplier thick speed so the game become more faster. `press 2` to switch always show all tower range. `press 3` to cheat gold and crystal hp
